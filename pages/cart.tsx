    ...
    <Layout title="ショッピングカート">
      {items.length > 0 ?
              ...
              <div className='bg-white h-52 md:w-[300px] p-4 '>
                ...
                <div className='flex flex-col'>
                  ...
                  >
                    ...
                    <Link href={"/"}>
                      <button className='mt-5 text-md hover:underline hover:opacity-50 transition-opacity'>&rarr;買い物をする</button>
                    </Link>
                </div>
          ...
          <div className="h-screen w-screen flex flex-col justify-center items-center gap-2 ">
            ...
            <Link href={"/"}>
              <button className='text-lg hover:underline hover:opacity-50 transition-opacity'>&rarr;買い物をする</button>
            </Link>
