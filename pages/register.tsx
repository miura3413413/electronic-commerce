      ...
      <div className='h-screen w-screen flex items-center justify-center'>
        <div className='bg-gray-200 w-[500px] h-[600px] flex flex-col  items-center rounded-xl border-2 border-gray-400'>
          ...
          <div className='flex flex-col items-center mt-5'>
            <label className='mb-2 text-xl border-b-2 border-gray-400' htmlFor='name'>名前</label>
            <input
              {...register('name', {
                required: {
                  value: true,
          ...
          <div className='flex flex-col items-center mt-5'>
            ...
            <button
              className={`mt-10 py-1 px-10 border-2 border-gray-400  rounded-2xl ${isDirty? "hover:opacity-50 hover:transition-opacity ":"border-gray-400"}`}
              type="submit"
              disabled={!isDirty}
            >
              登録
